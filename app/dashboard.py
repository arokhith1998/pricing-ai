...
# --- AI executive summary (enabled once a Claude key is configured) ----------
with st.container(border=True):
    st.markdown("##### 🧠 AI executive summary")
    st.caption("A board-ready narrative of this diagnostic, generated by Claude. "
               "Enabled once `ANTHROPIC_API_KEY` is set in `.env` — wiring next.")
